...

{
  ...
  local containers = k8sUtils.generateContainers(
    ...
    env=[
      ...
      k8sUtils.generateEnv(name='GF_AUTH_GENERIC_OAUTH_AUTH_URL', value='https://authentik.aetherrootr.com/application/o/authorize/'),
      k8sUtils.generateEnv(name='GF_AUTH_GENERIC_OAUTH_TOKEN_URL', value='https://authentik.aetherrootr.com/application/o/token/'),
      k8sUtils.generateEnv(name='GF_AUTH_GENERIC_OAUTH_API_URL', value='https://authentik.aetherrootr.com/application/o/userinfo/'),
      k8sUtils.generateEnv(name='GF_AUTH_SIGNOUT_REDIRECT_URL', value='https://authentik.aetherrootr.com/application/o/grafana/end-session/'),
