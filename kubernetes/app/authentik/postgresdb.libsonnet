...

{
  ...
  local containerImage = 'docker.io/library/postgres:16-alpine',
  ...
  local appEnv = std.prune([
    ...
    k8sUtils.generateSecretEnv(name='POSTGRES_PASSWORD', secretName=$.databasePasswordSecretName, key='postgres-password'),
  ]),
