...

{
  ...
  databaseSecretName:: error ('databasePasswordSecretName is required'),
  replicas:: 1,
  ...
  local appEnv = std.prune([
    ...
    k8sUtils.generateSecretEnv(name='POSTGRES_PASSWORD', secretName=$.databaseSecretName, key='db-password'),
  ]),
